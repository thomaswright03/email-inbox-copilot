...
export const es: Messages = {
  ...
  "briefing.count.deadlineToday_one": "{count} vence hoy",
  "briefing.count.deadlineToday_other": "{count} vencen hoy",
  ...
  "later.snoozeAria": "Posponer “{subject}”",
  ...
  "later.choice.nextWeek": "La próxima semana",
  "later.badge.snooze": "Vuelve de posponer",
  "later.badge.remind": "Recordatorio",
  "later.bannerLabel": "Recordatorios",
  "later.due.snooze": "Vuelve de posponer: “{subject}”",
  "later.due.remind": "Recordatorio: “{subject}”",
  "later.dueEarlier.snooze": "Ha vuelto un correo que pospusiste otro día.",
  "later.dueEarlier.remind": "Recordatorio de un correo de otro día.",
  "later.dismissAria": "Descartar el recordatorio de “{subject}”",
  "later.anEmail": "un correo",
  "later.snoozedList": "Pospuestos ({count})",
  "later.until": "hasta {time}",
  "later.unsnooze": "Mostrar ahora",
  "later.unsnoozeAria": "Mostrar “{subject}” ahora",
  "later.notificationTitle": "Recordatorio de Inbox Buddy",
  "later.notificationBody": "Ha llegado la hora de un correo que pediste recordar.",
  ...
  "errors.message_gone":
    "Este correo ya no está en tu bandeja de entrada. Puede que se haya eliminado o movido en Gmail.",
